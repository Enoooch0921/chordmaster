...
const localizedMeta: Record<AppLanguage, {
  ...
  en: {
    aboutSections: [
      {
        title: 'What It Is',
        description: 'Keep chord charts, Nashville numbers, jianpu, and song structure in one workflow.',
        bullets: [
          'Built for worship teams, pop rehearsal charts, teaching handouts, and quick transposition work.',
          'The editor and sheet preview stay in sync so layout issues are visible while you type.',
          'Supports both regular chord display and Nashville number display.'
        ]
      },
      {
        ...
        bullets: [
          ...
          'Export PDF directly for rehearsal use or live performance use.',
          'The visible version number tracks feature updates so you can identify the current build quickly.'
        ]
      }
    ],
    helpSections: [
      {
        ...
        bullets: [
          ...
          'Use the top bar to change Key, Capo, 123 Nashville numbers, and PDF export.',
      ...
      },
      {
        ...
        bullets: [
          ...
          'Common section names such as Count-In, Verse, Chorus, Bridge, and Interlude are ready to use.'
        ]
      },
      {
        title: 'Backup & Export',
        description: 'This is still a local browser-first workflow, so external backup is recommended.',
        bullets: [
          '`Save Changes` writes the current Song Library into this browser.',
    ...
    changelogEntries: [
      {
        version: APP_VERSION,
        date: '2026-04-01',
        title: 'Capo, Key, and editor flow update',
        bullets: [
          'Added the stepped Key menu, Original Key panel, Original highlighting, and support for C#, F#, and G#.',
          'Refined the Capo panel and sheet display into a cleaner guitar-oriented style with better key-based emphasis.',
          'Added rhythm copy/paste, resizable Song Library width, better card actions, and several chord and Nashville layout refinements.'
        ]
      },
      {
        version: '0.1.0',
