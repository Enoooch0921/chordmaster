-- Forward repair for environments that missed the original team_invite_inbox migration.
-- Keep the deployed RPC contract and existing invite tokens intact.
...
revoke all on function public.create_team_invite(text, text, text) from public, anon;
revoke all on function public.get_my_team_invites() from public, anon;
revoke all on function public.accept_team_invite(text) from public, anon;
revoke all on function public.accept_my_team_invite(uuid) from public, anon;
revoke all on function public.decline_my_team_invite(uuid) from public, anon;
